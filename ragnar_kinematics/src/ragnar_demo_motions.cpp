...
static trajectory_msgs::JointTrajectory makePickPlaceTrajectory()
{
  ...
  const double VERTICAL_MOVE_TIME = 0.25;
  ...
  // Down
  RagnarPose place1_down (0.2, 0.4, -0.4);
